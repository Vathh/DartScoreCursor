...
@section('content')
    <div class="container mx-auto py-8">
        ...
        <div class="mb-8 bg-lighter-bg p-6 rounded-lg shadow">
            ...
            @if(empty($guests))
                <p class="text-light-white">Brak graczy powiązanych z tym sezonem.</p>
            @else
        ...
        <form action="{{ route('seasons.guests.add', $season->id) }}" method="POST" class="mb-6 flex items-center space-x-4">
            @csrf
